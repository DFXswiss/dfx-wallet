...
| Swap (wallet-to-wallet exchange, coming soon)            | `(auth)/swap/index.tsx`, `features/buy-sell/SwapScreenImpl.tsx`, `features/buy-sell/TradeModeTabs.tsx`                                                                                                      | deferred (`EXPO_PUBLIC_ENABLE_BUY_SELL`)                                                                                                             | partial (`SwapScreenImpl.test.tsx`, `TradeModeTabs.test.tsx`)                                                                                                                   |
