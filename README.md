...
| Swap (placeholder)                                       | `(auth)/swap/index.tsx`, `features/buy-sell/SwapScreenImpl.tsx`, `TradeModeTabs`                                                                                                                           | deferred (`EXPO_PUBLIC_ENABLE_BUY_SELL`)                                                                                                             | partial (`test/components/SwapScreenImpl.test.tsx`, `test/components/TradeModeTabs.test.tsx`; no backend flow)                                                                   |
