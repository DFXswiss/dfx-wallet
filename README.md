...
| Create wallet via Passkey (WebAuthn PRF) | `(onboarding)/create-passkey.tsx`, `features/passkey/services/passkey-service.ts`, `key-derivation.ts` (HKDF → BIP-39) | deferred (`EXPO_PUBLIC_ENABLE_PASSKEY`) — iOS 18+ / Android 14+ | none                                                                                                 |
| Restore wallet via Passkey               | `(onboarding)/restore-passkey.tsx`, `features/passkey/services/setup-wallet.ts`                                        | deferred (`EXPO_PUBLIC_ENABLE_PASSKEY`)                         | none                                                                                                 |
