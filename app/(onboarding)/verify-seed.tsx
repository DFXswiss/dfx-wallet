...
export default function VerifySeedScreen() {
  ...
  // eslint-disable-next-line security/detect-object-injection -- currentStep is bounded to [0, VERIFY_COUNT)
  const currentIndex = verifyIndices[currentStep];
  // eslint-disable-next-line security/detect-object-injection -- currentIndex was generated by getRandomIndices(seedWords.length, ...)
